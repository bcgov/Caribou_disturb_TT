...
r.pest.tw <-  st_read(dsn = Base, layer ="Pest_clip_Tw_IBMIBS") #; plot(st_geometry(r.pest.tw))
    ...
    ### STILL OTO FIX THIS
    ## may need to manually fix this layer and 2010 layers


    #p.20002 <- st_union((Pest.dec.20002))
    p.20002 <- st_cast(Pest.dec.20002,"POLYGON") #; st_is_valid(p.20002)
...
arc.gdb= "Z:/01.Projects/Wildlife/Caribou/02.Disturbance/TweedTelkwa/Temp/Perkins/Outputs/disturb_layers/DistFinal_buff.gdb" # contains
